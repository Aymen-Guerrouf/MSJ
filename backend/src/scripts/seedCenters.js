...
const centersData = [
  ...
  },
  {
    ...
    clubs: [
      {
        ...
        category: 'tech',
        images: ['https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?q=80&w=1200'],
      },
      {
        name: 'Theater Club',
        description: 'Develop your acting skills and stage presence',
        category: 'arts',
        images: ['https://images.unsplash.com/photo-1503095396549-807759245b35?q=80&w=1200'],
      },
      {
        name: 'Environmental Club',
        description: 'Learn about sustainability and environmental protection',
        category: 'other',
        images: ['https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?q=80&w=1200'],
      },
    ],
    events: [
      {
        title: 'Tech Innovation Summit',
        description: 'Annual summit featuring latest technology trends and innovations',
      ...
      },
      {
        ...
        description: "Celebrate Constantine's rich cultural heritage through art and performance",
        date: new Date('2025-12-22T18:00:00'),
        category: 'culture',
    ...
    workshops: [
      ...
      {
        title: 'Drama & Acting Fundamentals',
        description: 'Learn the basics of acting, voice projection, and stage movement',
        date: new Date('2025-12-18T14:00:00'),
        category: 'arts',
        image: 'https://images.unsplash.com/photo-1507676184212-d03ab07a01bf?q=80&w=1200',
        seats: 20,
        price: 0,
        instructor: 'Samira Khelifi',
        duration: '2 weeks',
      },
    ],
  },
    ...
    for (const centerData of centersData) {
      ...
      if (center) {
        ...
        center = await Center.create({
          ...
          hasTour: centerData.hasTour || false,
